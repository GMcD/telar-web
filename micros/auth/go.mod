...
replace github.com/GMcD/telar-web v0.1.89 => github.com/GMcD/telar-web v0.1.101

replace github.com/GMcD/telar-web v0.1.74 => github.com/GMcD/telar-web v0.1.101

go 1.15

require (
	github.com/GMcD/cognito-jwt v0.0.0-20210806015718-8416e465865c
	github.com/GMcD/telar-web v0.1.101
