...
replace github.com/GMcD/telar-web v0.1.103 => github.com/GMcD/telar-web v0.1.109

replace github.com/GMcD/telar-web v0.1.107 => github.com/GMcD/telar-web v0.1.109

replace github.com/GMcD/telar-web v0.0.0-20210913144529-5d6f7a95512d => github.com/GMcD/telar-web v0.1.109

go 1.15

require (
	github.com/GMcD/cognito-jwt v0.0.0-20210806015718-8416e465865c
	github.com/GMcD/telar-web v0.1.109
